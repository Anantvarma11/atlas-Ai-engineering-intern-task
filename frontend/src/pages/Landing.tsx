      ...
      <main className="mx-auto max-w-4xl px-6">
        <div className="py-16 sm:py-24">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <a href="https://github.com/Anantvarma11/atlas-hotels" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-sm font-medium text-cyan-500 hover:text-cyan-400 transition">
